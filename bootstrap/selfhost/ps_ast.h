...
typedef enum { PT_UNKNOWN = 0, PT_INT, PT_FLOAT, PT_BOOL, PT_STR, PT_ANY, PT_NAME, PT_LIST, PT_DICT, PT_SET, PT_ARRAY, PT_TUPLE, PT_OPT, PT_FUNC, PT_TASK, PT_WORKER, PT_FILE, PT_BUFFER, PT_TIMER, PT_DYN, PT_VOID } PsTypeKind;
...
typedef enum { PE_INT = 0, PE_FLOAT, PE_STR, PE_FSTR, PE_BOOL, PE_NONE, PE_NAME, PE_UNARY, PE_BINARY, PE_TERNARY, PE_CALL, PE_INDEX, PE_SLICE, PE_FIELD, PE_OPTFIELD, PE_OPTINDEX, PE_COALESCE, PE_CAST, PE_CONVERT, PE_TUPLE, PE_LIST, PE_DICT, PE_SET, PE_COMPREHEND, PE_LAMBDA, PE_WALRUS, PE_AWAIT, PE_SPAWN, PE_IN, PE_IS, PE_DESIG, PE_LOWERED } PsExprKind;
