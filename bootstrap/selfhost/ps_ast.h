...
typedef enum { PT_UNKNOWN = 0, PT_INT, PT_FLOAT, PT_BOOL, PT_STR, PT_BYTES, PT_ANY, PT_NAME, PT_LIST, PT_DICT, PT_SET, PT_ARRAY, PT_TUPLE, PT_OPT, PT_FUNC, PT_TASK, PT_WORKER, PT_FILE, PT_BUFFER, PT_WATCHER, PT_SEQ, PT_PATTERN, PT_DIRITER, PT_DECODER, PT_MAPPING, PT_VIEW, PT_CONN, PT_PROC, PT_TIMER, PT_CHAN, PT_GROUP, PT_DYN, PT_VOID } PsTypeKind;
...
typedef enum { PS_EXPR = 0, PS_VAR, PS_UNPACK, PS_ASSIGN, PS_RETURN, PS_IF, PS_WHILE, PS_FOR, PS_MATCH, PS_BREAK, PS_CONTINUE, PS_PASS, PS_RAISE, PS_TRY, PS_WITH, PS_DEFER, PS_ASSERT, PS_GLOBAL, PS_NONLOCAL, PS_UNSAFE, PS_NOGC, PS_NOCHECK } PsStmtKind;
