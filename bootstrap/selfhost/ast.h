...
typedef enum { EX_IDENT = 0, EX_NUMBER, EX_STRING, EX_CHARLIT, EX_TRUE, EX_FALSE, EX_NONE, EX_UNARY, EX_BINARY, EX_TERNARY, EX_CALL, EX_INDEX, EX_FIELD, EX_CAST, EX_INITLIST, EX_TYPEREF, EX_INCDEC, EX_DESIG, EX_ASSIGN, EX_COMMA, EX_COMPOUND, EX_VAARG, EX_GENERIC, EX_STMTEXPR, EX_WITHSELF, EX_WALRUS, EX_IN, EX_LAMBDA, EX_FSTRING } ExprKind;
